...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "MiniKerumi | GFX Artist & Animator",
      },
      {
...
const tracks = [
  {
    title: "Daily Life · Leisure",
    artist: "Sān-Z / HOYO-MiX",
    src: dailyLifeLeisure,
  },
  {
    title: "Daily Life · Freedom",
    artist: "Sān-Z",
    src: dailyLifeFreedom,
  },
  {
    title: "Reverie · Serenity",
    artist: "Sān-Z",
    src: reverieSerenity,
  },
  {
...
function Index() {
  ...
  useEffect(() => {
    ...
    const closeOnEscape = (event: KeyboardEvent) =>
      event.key === "Escape" && setActiveWork(null);
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      <nav
        ...
        className="absolute inset-x-0 top-0 z-30 border-b border-foreground/15 bg-background/70 backdrop-blur-md"
      >
        ...
        <div className="mx-auto grid max-w-[92rem] gap-10 px-5 lg:grid-cols-[0.7fr_1.5fr] lg:px-10">
          ...
          <div className="max-w-3xl self-end border-l border-primary pl-6 sm:pl-10">
            ...
            <p className="mt-6 max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg">
              I’m always experimenting, practicing, and finding something new
              to love in every piece I make. Outside of art, I’m a network
              engineer with a Bachelor of Science in Information Technology,
              specializing in Network Technology.
            </p>
          </div>
        </div>
      </section>
      ...
      <section
        id="animation"
        className="border-y border-border bg-card/60 py-20 lg:py-28"
      >
        <div className="mx-auto max-w-[92rem] px-5 lg:px-10">
          <div
            className="mb-10 flex items-end justify-between border-b border-border pb-5"
